...
namespace SensorDeviceService.Controllers
{
    ...
    {
        private SensorsList _sensorsList;

        public SensorDeviceController()
        {
            _sensorsList = SensorsList.GetSensorsListInstance();//pravi listu listi senzora, tj u ovo jedno _sensorList se nalazi vise listi, \
            //jer se za svaki txt pravi nova instanca SensorList...
        }
